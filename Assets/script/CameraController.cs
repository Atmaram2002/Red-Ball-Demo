...
public class CameraController : MonoBehaviour
{
    ...
    { 
        ...
        {
            targetPosition = LimitPositionToBoundns(targetPosition);
        }
    ...
    {
        //Get the bottom left(0,0) and top right(1,1)of the view port [screen]
    ...
    Vector3 LimitPositionToBoundns(Vector3 position)
    {
        //set x position when exceed min and max x position
        ...
        //set y position when exceed min and max  y position 
